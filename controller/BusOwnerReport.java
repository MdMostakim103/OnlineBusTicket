...
public class BusOwnerReport {
    ...
    public void backToPrevScene(ActionEvent event) throws IOException, ClassNotFoundException {
        ...
        String css = this.getClass().getResource("/view/BusOwnerHomePage.css").toExternalForm();
    ...
    private void submitReport() {
        ...
        Message messageObj = new Message("BusOwner",busId,"Admin",adminName,reportText);
        Request req=new Request("BusOwner","ContactAdmin",messageObj.toCSV());
    ...
    public void setBusOwner(String busId,String name){
        this.busId = busId;
        this.name=name;
    }
